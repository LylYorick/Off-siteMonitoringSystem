...
<body>
	...
	<div  class="ui-banner  ui-noBottomboder">
		...
		<input type="button" id="verifyPass" value="审核通过" class="ui-button ui-widget ui-state-default ui-corner-all" role="button" aria-disabled="false">
		<input type="button" id="verifyReject" value="审核拒绝" class="ui-button ui-widget ui-state-default ui-corner-all" role="button" aria-disabled="false">
		</div>
	...
	<div id="gridtable_pager" ></div> 
			<table class="wwFormTable" style="width: 100%;" id="tabel_detail" >
				...
				<tr>
					...
					<td>
						<textarea  class="textarea " readonly="readonly" >违反保密规定，出现失密、泄密情况，导致严重后果</textarea>
					</td>
					<td>
						<textarea  class="textarea alterTextarea" id="textarea1" ></textarea>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input id="checkbox2" type="checkbox"  value="checkbox">
					</td>
					<td>
						2017
					</td>
					...
					<td>
						<label id="label2" class="label">待审核</label>
					</td>
					<td>
						50
					</td>
					...
					<td>
						<textarea  class="textarea alterTextarea" id="textarea2" ></textarea>
					</td>
