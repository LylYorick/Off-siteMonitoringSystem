...
function update_c(json){
   ...
   for(var i in sort){   
	...
	<div class="grid">
		...
		<br>
		<s:form namespace="/jsonlist" action="cacul_list" method="post">
		...
		<sj:grid id="gridtable" caption="报表上报情况[默认显示是本年度上季度报表上报情况]" dataType="json"
			href="../jsonlist/cacul_list.shtml" gridModel="gridModel"
			...
			<sj:gridColumn name="r1" index="r1" title="报表1" width="70" formatter="formatLink"/>
			<sj:gridColumn name="r2" index="r2" title="报表2" width="70" formatter="formatLink"/>
			<sj:gridColumn name="r3" index="r3" title="报表3" width="70" formatter="formatLink"/>
			<sj:gridColumn name="r4" index="r4" title="报表4" width="70" formatter="formatLink"/>
			<sj:gridColumn name="r5" index="r5" title="报表5" width="70" formatter="formatLink"/>
			<sj:gridColumn name="r6" index="r6" title="报表6" width="70" formatter="formatLink"/>
			<sj:gridColumn name="r7" index="r7" title="报表7" width="70" formatter="formatLink"/>
			<sj:gridColumn name="r8" index="r8" title="报表8" width="70" formatter="formatLink"/>
			<sj:gridColumn name="r9" index="r9" title="报表9" width="70" formatter="formatLink"/>
			<sj:gridColumn name="r10" index="r10" title="报表10" width="70" formatter="formatLink"/>
		</sj:grid>
		...
		function formatLink(cellvalue, options, rowObject) { 
			if(cellvalue=="0"){
				return "<span style='color:green;'>已上报</span>";
					...
					return "<span style='color:red'>待上报</span>";
				}else if(cellvalue=="2"){
					return "<span style='color:blue'>未上报</span>";
				}else{
					return "无";
				}
        } 
