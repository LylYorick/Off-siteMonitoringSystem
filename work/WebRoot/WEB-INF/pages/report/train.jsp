...
<head>
	<title>金融机构反洗钱培训活动情况录入</title>
</head>
<body>
	<script type="text/javascript"> 
		$(document).ready(function() {
  	 		$('#report_trainsave_train_trcnt').maxlength();
		});
	...
	<div class="grid">
		<fieldset>
			...
			<br>
			<s:form namespace="/report" action="report_trainsave" method="post">
				...
				<s:textarea label="培训内容" required="true" name="train.trcnt" rows="8" cols="80">
				</s:textarea>
				...
				<s:submit align="center" value="提    交" theme="simple"
				 ...
				 <s:hidden name="train.reportswitch.switchid" value="%{switchid}"></s:hidden>
