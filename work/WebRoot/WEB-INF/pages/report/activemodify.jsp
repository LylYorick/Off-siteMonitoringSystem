...
<head>
	<title>金融机构反洗钱宣传活动情况修改</title>
</head>
<body>
	<script type="text/javascript"> 
		$(document).ready(function() {
  	 		$('#report_activeupdate_active_actcnt').maxlength();
  	 		$('#report_activeupdate_active_actmtd').maxlength();
		});
    </script>
	<div class="grid">
		<fieldset>
			...
			<br>
			<s:form namespace="/report" action="report_activeupdate" method="post">
				...
				<s:textarea label="宣传内容" required="true" name="active.actcnt" rows="8" cols="80">
				</s:textarea>
				...
				<s:submit align="center" value="提    交" theme="simple"
				 ...
				 <s:hidden name="active.reportswitch.switchid" value="%{active.reportswitch.switchid}"></s:hidden>
				<s:hidden name="active.proid" value="%{id}"></s:hidden>
