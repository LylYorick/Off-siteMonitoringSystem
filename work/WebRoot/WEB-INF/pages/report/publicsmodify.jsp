...
<head>
	<title>金融机构协助公安机关、其他机关打击洗钱活动情况修改</title>
</head>
<body>
	<script type="text/javascript"> 
    	$(document).ready(function() {
  	 		$("#starttime").datepicker({changeMonth: true,changeYear: true});
  	 		$('#report_publicsupdate_publics_xp3').maxlength();
  	 		$('#report_publicsupdate_publics_xp4').maxlength();
		});
    </script>
	<div class="grid">
		<fieldset>
			...
			<br>
			<s:form namespace="/report" action="report_publicsupdate" method="post">
				...
				<s:hidden name="publics.reportswitch.switchid" value="%{publics.reportswitch.switchid}"></s:hidden>
				<s:hidden name="publics.xpid" value="%{id}"></s:hidden>
