...
<head>
	<title>内控制度建设情况录入</title>
</head>
<body>
	<script type="text/javascript">
			$(document).ready(function() {
  	 		$('#report_innercontrolsave_innercontrol_icontent').maxlength();
	...
	<div class="grid">
		<fieldset>
			...
			<br>
			<s:form namespace="/report" action="report_innercontrolsave" method="post">
				<s:bean name="java.util.HashMap" id="qTableLayout">
					<s:param name="tablecolspan" value="%{2}" />
				</s:bean>
				<s:textfield label="制度名称" required="true" name="innercontrol.iname" size="60">
				...
				<s:submit align="center" value="提    交" theme="simple"
				 ...
				 <s:hidden name="innercontrol.reportswitch.switchid" value="%{switchid}"></s:hidden>
