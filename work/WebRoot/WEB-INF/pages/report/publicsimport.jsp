...
<body>
	...
	<div class="grid">
		<fieldset>
			...
			<br>
			<s:form namespace="/report" action="report_publicsImportsave" method="post"  enctype="multipart/form-data">
				...
				<tr><td>模板下载</td><td><a href="<%=request.getContextPath()%>/templete/13.xls">模板</a></td></tr>
