...
<head>
	<title>反洗钱调查信息管理>>线索来自司法机关录入</title>
</head>
<body>
<script type="text/javascript">
	...
	<div class="grid">
		<fieldset>
			...
			<br>
			<s:form namespace="/judicialcule" action="judicialcule_save" method="post" enctype="multipart/form-data">
				<s:bean name="java.util.HashMap" id="qTableLayout">
				<s:param name="tablecolspan" value="%{2}" />
			</s:bean>
				<%--<s:textfield label="序号" required="true"></s:textfield>
				<s:textfield name="jid" label="案件总编号" required="true"></s:textfield>--%>
				...
				<s:textfield name="casename" label="案件名称" required="true"></s:textfield>
				<s:textfield name="typeofcrime" label="涉嫌犯罪类型" required="true"></s:textfield>
				<s:textfield name="cluessource" label="侦查机关线索来源" required="true"></s:textfield>
				...
				<s:textarea cols="30" rows="5" name="notes" label="备注" required="true"></s:textarea>
				<s:file name="judicialculeFile" label="可疑主体数据"><s:param name="remark" value="%{'[说明:可疑主体信息包括主体名称，主体证件号码'}" /></s:file>
